...
export function ImportButton({ shareToken }: { shareToken: string }) {
  ...
  return (
    <button
      ...
      disabled={isPending}
      className={clsx(
        "inline-flex items-center gap-2 rounded-md bg-primary-600 px-4 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-primary-500 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary-600",
