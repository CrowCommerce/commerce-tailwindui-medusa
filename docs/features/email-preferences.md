...
2. Any email recipient can manage preferences from `/email-preferences?token=...` without signing in.
...
- Footer preference links injected into customer-facing emails
